...
#
#SBATCH --job-name=melting       # The name of your job, you'll se it in squeue.
...
#
#SBATCH --mem=63000                 # Memory per node (MAX: 63500 on the new ones, 40000 on the old ones); incompatible with --mem-per-cpu.
