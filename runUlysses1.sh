...
do
    ...
    #echo $N $eps $d $(( $d+$dis_per_thread )) $overwrite | python3 spectrum.py 1>>log 2>>err_n${N}_e${eps} &
    echo $N $eps $eig_frac $d $(( $d+$dis_per_thread )) $overwrite | python3 spectrum_sparse.py 1>>log 2>>err_n${N}_e${eps} &
done
