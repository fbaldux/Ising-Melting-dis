...
np.savetxt("Plots/PE_cut.txt", np.stack((Ns,cuts)).T, header="N cut", fmt="%d %e")
#exit(0)
...
#plt.savefig("Plots/PE_cut.pdf", bbox_inches='tight')
plt.show()
